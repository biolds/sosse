...
class SimpleTest(TestCase):
    ...
    def _check(self):
        ...
        self.assertEqual(doc.title, 'The install worked successfully! Congratulations!')
        self.assertEqual(doc.normalized_title, 'The install worked successfully! Congratulations!')

        self.assertIn('You are seeing this page because DEBUG=True', doc.content)
        self.assertIn('You are seeing this page because DEBUG=True', doc.normalized_content)
